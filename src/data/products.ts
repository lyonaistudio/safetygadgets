...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    specs: [
      { label: "Tracker GPS OBD", value: "Suivi temps réel 4G, installation sans câblage (29,99 € à l'unité)" },
      { label: "Alarme SOS", value: "Sirène 130 dB, alerte SMS + position GPS (34,99 € à l'unité)" },
      { label: "Prix du pack", value: "54,98 € TTC au lieu de 64,98 €" },
